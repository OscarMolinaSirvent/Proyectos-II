...
if __name__ == "__main__":
    ...
    tub1, tub2 = Pipe() #Duplex = True para habilitar comunicacion en ambos sentidos
    ...
    #Utilizar el comando sudo ./venv/bin/python3 Ejercicio2/Tuberias.py 
    # para ejecutar el programa, en caso de que nos pida acceso superior (root)
